...
import { LayoutDashboard, Users, ListChecks, DollarSign, BarChart2, Building, Landmark, SlidersHorizontal, Handshake, ClipboardList, Archive, Database, ChevronDown, NotebookText, UsersRound, Megaphone, Mail } from 'lucide-react';
...
const navItems: NavItem[] = [
  ...
  { id: 'mail', label: 'Email', icon: Mail, permission: 'canManageEmail' },
